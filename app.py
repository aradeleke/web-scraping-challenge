...
def home():
    ...
    return render_template("index.html", title_para=title_and_para_data, mars_img = mars_image_data, facts = mars_facts_data, img1 = img1_data, img2 = img2_data, img3 = img3_data, img4 = img4_data)
